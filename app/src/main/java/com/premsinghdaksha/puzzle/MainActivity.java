...
import com.premsinghdaksha.puzzle.adapter.PuzzleAdapter;
        ...
        obs.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {//width=lGrid.getWidth();
                if (widthCheck) {
                    ...
                    puzzlePiecesList = puzzle.createPuzzlePieces(MainActivity.this, null, widthFinal, heightFinal, imageView, "/puzzles/", 3, 3);
                    getAdapter();
                    widthCheck = false;
                }
            }
